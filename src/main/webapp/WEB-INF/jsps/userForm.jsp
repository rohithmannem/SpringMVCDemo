...
<script type="text/javascript">
  function validate()
  {
       ...
       if(name == null || name =="" || name.length <8) {
    	   document.getElementById("name-error").value = "Please enter a valid nane";
    	   return false;
       }
     else
...
<body>
	...
	<spring:url value="/user/submitUser" var="userActionUrl" />
	...
	<form:form class="form-horizontal" method="post" modelAttribute="userForm" action="${userActionUrl}">
			...
			<spring:bind path="name">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					...
					<div class="col-sm-10">
						...
						<form:errors path="name" class="control-label" id = "name-error"/>
					</div>
				</div>
			</spring:bind>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn-lg btn-primary pull-right" onclick=validate();>Create Profile </button>
				</div>
